...
navHome.textContent = localStorage.getItem('taal') === 'nl' ? 'Thuis' : 'Home';
...
subnav_home_item1.textContent = localStorage.getItem('taal') === 'nl' ? 'Over ons' : 'About us';
subnav_home_item2.textContent = localStorage.getItem('taal') === 'nl' ? 'Contact' : 'Contact';
subnav_home_item3.textContent = localStorage.getItem('taal') === 'nl' ? 'Hulp' : 'Help';
